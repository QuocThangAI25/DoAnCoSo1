...
public class xuatPDF {
    ...
    // ===== ĐỔI SỐ -> CHỮ (đơn giản, đủ dùng cho bài) =====
    ...
    // ===== XUẤT PHIẾU CHI =====
    public static void xuatPhieuChi(
            String ma,
            String loai,
            String tenGV,
            LocalDate ngay,
        ...
        try {
            ...
            Image logo = Image.getInstance(
                    xuatPDF.class.getResource("toplenn.jpeg")
            );
            ...
            document.add(new Paragraph("Tên GV: " + tenGV, textFont));
            ...
            // ===== KÝ TÊN =====
            Paragraph ky = new Paragraph("Người chi", textFont);
